...
class PlaylistsService {
  ...
  // TODO move this method to consumer app
  async getPlaylistByPlaylistId(playlistId) {
    // prep FIRST query: Per requirement, need id, name from playlists from now,
    ...
    /** prep SECOND query: fetch playlist_song tables,
